    ...
    <main className="flex flex-col items-center w-full min-h-[calc(100vh-300px)] bg-[#f6f8f6] dark:bg-[#142210] text-[#131811] dark:text-white font-sans">
      <div className="w-full px-4 md:px-10 py-8 max-w-[1400px]">
        <div className="flex items-center gap-4 mb-8">
          <Link
            className="p-2 rounded-full hover:bg-[#e5e8e5] dark:hover:bg-[#2c3928] transition-colors"
            href="/"
          >
            <span className="material-symbols-outlined text-[#131811] dark:text-white">
              arrow_forward
            </span>
          </Link>
          <h1 className="text-3xl font-black text-[#131811] dark:text-white tracking-tight">
            سلة المشتريات
          </h1>
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <Link
              href="/"
              className="px-8 py-3 bg-primary text-[#131811] rounded-full font-bold hover:bg-opacity-90 transition-all"
            >
              تصفح المنتجات
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            <div className="flex-1 w-full flex flex-col gap-4">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row items-center gap-6 p-5 rounded-[1.5rem] bg-white dark:bg-[#1e271c] border border-[#e5e8e5] dark:border-[#2c3928] shadow-sm hover:border-primary dark:hover:border-primary transition-all duration-300"
                >
                  ...
                  <div className="flex-1 flex flex-col items-center sm:items-start text-center sm:text-right gap-1 w-full">
                    ...
                    <p className="text-sm text-gray-500 dark:text-[#a3b99d]">
                      {(item as any).authors ? (item as any).authors[0] : ""}
                    </p>
                  </div>
            ...
            <div className="w-full lg:w-[400px] flex-shrink-0">
              <div className="bg-white dark:bg-[#1e271c] p-8 rounded-[1.5rem] border border-[#e5e8e5] dark:border-[#2c3928] sticky top-28 shadow-sm">
                <h2 className="text-2xl font-bold text-[#131811] dark:text-white mb-6">
                  ملخص الطلب
                </h2>
                <div className="flex flex-col gap-4 mb-6 border-b border-[#e5e8e5] dark:border-[#2c3928] pb-6">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-500 dark:text-[#a3b99d]">
                      المجموع الفرعي
                    </span>
                ...
                <div className="flex items-center justify-between mb-8">
                  <span className="text-lg font-bold text-[#131811] dark:text-white">
                    الإجمالي
                  </span>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Link
                    href="/"
                    className="w-full h-12 flex items-center justify-center rounded-full border-2 border-transparent hover:border-[#e5e8e5] dark:hover:border-[#2c3928] text-gray-500 dark:text-[#a3b99d] hover:text-[#131811] dark:hover:text-white transition-all text-sm font-bold"
                  >
                    العودة للتسوق
                  </Link>
                </div>
