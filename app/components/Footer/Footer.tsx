export default function Footer() {
  return (
    <footer className="bg-white dark:bg-[#1e271c] border-t border-[#e5e8e5] dark:border-[#2c3928] py-12 px-10">
      ...
      <div className="max-w-[1400px] mx-auto mt-12 pt-6 border-t border-[#e5e8e5] dark:border-[#2c3928] flex items-center justify-between">
