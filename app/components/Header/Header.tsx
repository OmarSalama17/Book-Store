export default function Header() {
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e5e8e5] dark:border-[#2c3928] px-10 py-4 bg-background-light dark:bg-background-dark sticky top-0 z-50">
